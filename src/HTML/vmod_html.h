char *html = 	"<!DOCTYPE html>"
	...
	"             <a class=\"navbar-brand\" href=\"https://github.com/arianna-aondio/libvmod-rtstatus\">Github repository</a>          </div>"
	"      </div>"
	"    </div>"
	"    <div class=\"jumbotron\">"
	...
	"      <div class=\"container\">"
	"	<div class=\"navbar-header\">"
	"        <a class=\"navbar-brand\" <a href=\"/rtstatus.json\">Complete JSON file</a>"
	"	<a href=\"varnish-cache.org\">&copy;Copyright 2014 Varnish Software AS</a>"
	"	</div>"
	"      </div>"
	"    </div>"
	"    </div> <!-- /container -->"
